...
pub use loader::{
    ...
    load_defaults, load_from_dir, load_target_defaults, load_target_from_file,
    load_targets_from_dir, target_manifest_in_dir, user_targets_dir,
    load_from_file, manifest_in_plugin_dir, user_plugins_dir,
};
pub use manifest::PluginManifest;
pub use target::{
    ResolvedTarget, ResolvedTargetSpawn, TargetConnect, TargetManifest, TargetSpawn,
};
